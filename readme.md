# Marine Vehicle Classification Dataset 7000 images Supports YOLO Training Marine Label

# Body

The ship classification detection dataset consists of 7000 images, supporting YOLO training. The labels for the dataset include: ore carrier, passenger ship, container ship, bulk cargo carrier, general cargo ship, fishing boat. The dataset has been divided into a training set and a test set, which can be directly used for learning research, graduation projects, and model training.
The are available for purchase at once upon request, and as , they cannot be returned or exchanged.
